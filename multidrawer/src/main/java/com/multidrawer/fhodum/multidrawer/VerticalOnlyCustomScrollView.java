...
/**
 * Created by fhodum on 5/3/16.
 */
public class VerticalOnlyCustomScrollView extends ScrollView{


    private GestureDetector gestureDetector;
    View.OnTouchListener gestureListener;

    public VerticalOnlyCustomScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
